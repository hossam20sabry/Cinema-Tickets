        ...
        <div class="main-panel">
           ...
           <div class="row content_center px-5">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">update {{$kind->title}}</h4>

                    <form class="forms-sample" id="showTimeForm">
                        @csrf
                        <input type="hidden" name="kind_id" id="kind_id" value="{{$kind->id}}">
                        <div class="form-group">
                            <label for="title">title</label>
                            <input  type="text"  class="form-control mystyle" name="title" id="title" placeholder="title" value="{{$kind->title}}">
                        </div>
