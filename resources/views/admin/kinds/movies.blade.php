...
@section('head_name', $kind->title.' Movies')
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-panel">
          ...
          <div class="row content_center">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">{{$kind->title}} Movies</h4>
                    </p>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          @foreach ($kind->movies as $movie)
                            <tr>
                              <td>{{$movie->name}}</td>
                              <td><a class="badge badge-warning" href="{{route('movies.show', $movie->id)}}">info</a></td>
                              <td>{{$movie->rating}}</td>
                              {{-- <td>@foreach($movie->kinds as $kind) {{$kind->title}}, @endforeach</td> --}}
