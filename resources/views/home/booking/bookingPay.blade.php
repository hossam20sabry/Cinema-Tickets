...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/home/css/pay.css')}}">
                    ...
                    <form 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                @if($booking->payment_status == true) @disabled(true)  @endif 
                                type="submit">
                                Pay Now @if($booking->payment_status != true) (${{$total_price}}) @endif 
                                </button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="/" class="btn btn-success btn-lg btn-block margin_top">  Back To Home </a>
                            </div>
                        </div>
